...
const services = [
    {
        ...
        icon: <Fingerprint className="w-6 h-6" strokeWidth={1.5} />,
        highlight: false
    },
    {
    ...
    },
    {
        ...
        icon: <HeartCrack className="w-6 h-6" strokeWidth={1.5} />,
    },
    {
    ...
    },
    {
        ...
        icon: <Stamp className="w-6 h-6" strokeWidth={1.5} />,
    },
    {
                ...
                <div className="text-center mb-16 max-w-3xl mx-auto">
                    <Reveal variant="fade-up" duration="slow">
                        <h2 className="text-3xl md:text-5xl font-black text-neutral-900 tracking-tight leading-[1.1] mb-6">
                            ¿Qué documento necesitas? <br className="hidden md:block" />
                            <span className="text-neutral-500">Nos encargamos de todos</span>
                        </h2>
                    </Reveal>
                </div>
                        ...
                        >
                            ...
                            `}>
                                ...
                                <div className={`
                                    ...
                                    ${service.highlight ? "bg-[var(--brand-light)]/10 opacity-100" : "group-hover:opacity-100 bg-gradient-to-tr from-transparent via-white/40 to-transparent"}
                                `} />

                                <div className={`
                                    flex items-center justify-center w-12 h-12 rounded-xl shrink-0 transition-colors duration-300
                                    ${service.highlight ? "bg-[var(--brand-light)] text-[var(--brand-dark)]" : "bg-neutral-100/50 text-neutral-600 group-hover:bg-[var(--brand-light)] group-hover:text-[var(--brand-dark)]"}
                                `}>
                                ...
                                <h3 className={`font-bold leading-tight transition-colors duration-300 ${service.highlight ? "text-[var(--brand-dark)] text-lg" : "text-neutral-700 group-hover:text-neutral-900"}`}>
                                    {service.title}
                                </h3>

                                <div className={`ml-auto transition-transform duration-300 group-hover:translate-x-1 ${service.highlight ? "text-[var(--brand-dark)]" : "text-neutral-400 group-hover:text-[var(--brand-dark)]"}`}>
